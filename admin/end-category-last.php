...
<section class="content-header">
	<div class="content-header-left">
		<h1>View Last End Level Categories</h1>
	</div>
	<div class="content-header-right">
		<a href="end-category-last-add.php" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-hover table-striped">
			<thead>
			    <tr>
			        <th>#</th>
			        <th>Last End Level Category Name</th>
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr>
	                    <td><?php echo $i; ?></td>
	                    <td><?php echo $row['lecat_name']; ?></td>
	                    <td><?php echo $row['ecat_name']; ?></td>
                        <td><?php echo $row['mcat_name']; ?></td>
                        <td><?php echo $row['tcat_name']; ?></td>
	                    <td>
	                        <a href="end-category-last-edit.php?id=<?php echo $row['lecat_id']; ?>" class="btn btn-primary btn-xs">Edit</a>
	                        <a href="#" class="btn btn-danger btn-xs" data-href="end-category-last-delete.php?id=<?php echo $row['lecat_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>
	                    </td>
	                </tr>
            		<?php
            	}
