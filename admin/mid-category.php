                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <?php
                            $i = 0;
                            $statement = $pdo->prepare("SELECT t1.*, t2.tcat_name 
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($row['mcat_img'])) : ?>
                                            <img src="uploads/mid_category/<?php echo htmlspecialchars($row['mcat_img']); ?>" alt="Mid Category Image" style="width:100px;">
                                        <?php else : ?>
                                            No Image
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if (!empty($row['mcat_bg_img'])) : ?>
                                            <img src="uploads/mid_category/<?php echo htmlspecialchars($row['mcat_bg_img']); ?>" alt="Mid Category Background Image" style="width:100px;">
                                        <?php else : ?>
                                            No Background Image
                                        <?php endif; ?>
                                    </td>
                                    <td><a href="<?php echo htmlspecialchars($row['mcat_url']); ?>"><?php echo htmlspecialchars($row['mcat_url']); ?></a></td>
                                    <td>
