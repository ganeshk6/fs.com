...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("INSERT INTO tbl_last_category (lecat_name,ecat_id) VALUES (?,?)");
		$statement->execute(array($_POST['lecat_name'],$_POST['ecat_id']));
	
    	$success_message = 'Last End Level Category is added successfully.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Add Last End Level Category</h1>
	</div>
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="lecat_name">
							</div>
						</div>
