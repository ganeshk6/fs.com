...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $statement = $pdo->prepare("INSERT INTO tbl_case_studies (study_img, country_flag, country_name, study_heading, study_content, url) VALUES (?,?,?,?,?,?)");
        $statement->execute(array($study_img, $country_flag, $_POST['country_name'], $_POST['study_heading'], $_POST['study_content'], $_POST['url']));

        $success_message = 'Case Study is added successfully.';
    }
}
?>
            ...
            <div class="box box-info">
                <div class="box-body">
                    ...
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Country Flag <span>*</span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="study_heading">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Content <span>*</span></label>
                            <div class="col-sm-10">
                                <textarea class="form-control" name="study_content" style="height:100px;"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
