	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">ClenFay</span>
			</a>
...
<!-- Side Bar to Manage Shop Activities -->
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'size.php') || ($cur_page == 'size-add.php') || ($cur_page == 'size-edit.php') || ($cur_page == 'color.php') || ($cur_page == 'color-add.php') || ($cur_page == 'color-edit.php') || ($cur_page == 'country.php') || ($cur_page == 'country-add.php') || ($cur_page == 'country-edit.php') || ($cur_page == 'shipping-cost.php') || ($cur_page == 'shipping-cost-edit.php') || ($cur_page == 'top-category.php') || ($cur_page == 'top-category-add.php') || ($cur_page == 'top-category-edit.php') || ($cur_page == 'mid-category.php') || ($cur_page == 'mid-category-add.php') || ($cur_page == 'mid-category-edit.php') || ($cur_page == 'end-category.php') || ($cur_page == 'end-category-add.php') || ($cur_page == 'end-category-edit.php') ) {echo 'active';} ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="end-category-last.php"><i class="fa fa-circle-o"></i>Last End Level Category</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview <?php if( ($cur_page == 'order.php') ) {echo 'active';} ?>">
                     ...
                     <li class="treeview <?php if( ($cur_page == 'software-plateform.php') ) {echo 'active';} ?>">
			          <a href="software-plateform.php">
			            <i class="fa fa-picture-o"></i> <span>Software Plateform</span>
			          </a>
			        </li>
                     <li class="treeview <?php if( ($cur_page == 'feature_solutions.php') ) {echo 'active';} ?>">
			          <a href="feature_solutions.php">
			            <i class="fa fa-laptop"></i> <span>Manage Feature Solutions</span>
			          </a>
			        </li>
                     <li class="treeview <?php if( ($cur_page == 'fs_certified.php') ) {echo 'active';} ?>">
			          <a href="fs_certified.php">
			      ...
			      <li class="treeview <?php if( ($cur_page == 'cupan.php')||($cur_page == 'cupan.php') ) {echo 'active';} ?>">
			          <a href="cupan.php">
			            <i class="fa fa-hand-o-right"></i> <span>Coupon</span>
			          </a>
			        </li>
